...
var MatExpansionPanel = class _MatExpansionPanel extends CdkAccordionItem {
  ...
  constructor(accordion, _changeDetectorRef, _uniqueSelectionDispatcher, _viewContainerRef, _document, _animationMode, defaultOptions) {
    ...
    this._inputChanges = new import_rxjs2.Subject();
...
var MatExpansionPanelHeader = class _MatExpansionPanelHeader {
  constructor(panel, _element, _focusMonitor, _changeDetectorRef, defaultOptions, _animationMode, tabIndex) {
    ...
    this._changeDetectorRef = _changeDetectorRef;
    this._animationMode = _animationMode;
    this._parentChangeSubscription = import_rxjs2.Subscription.EMPTY;
    this.tabIndex = 0;
    const accordionHideToggleChange = panel.accordion ? panel.accordion._stateChanges.pipe((0, import_operators.filter)((changes) => !!(changes["hideToggle"] || changes["togglePosition"]))) : import_rxjs2.EMPTY;
    this.tabIndex = parseInt(tabIndex || "") || 0;
    this._parentChangeSubscription = (0, import_rxjs2.merge)(panel.opened, panel.closed, accordionHideToggleChange, panel._inputChanges.pipe((0, import_operators.filter)((changes) => {
